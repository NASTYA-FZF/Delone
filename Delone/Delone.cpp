...
// Delone.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDeloneApp, CWinApp)
...
// Единственный объект CDeloneApp

CDeloneApp theApp;


// Инициализация CDeloneApp

BOOL CDeloneApp::InitInstance()
{
